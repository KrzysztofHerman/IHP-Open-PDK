...
plt.hist(Vgs, bins=100)
plt.title('Monte Carlo simulation of the $I_{D}$ mismatch between two mos devices')  # Replace with your X-axis label
plt.ylabel('Counts')  # Replace with your Y-axis label
plt.xlabel('$I_{D}$ current [V]')  # Replace with your plot title
# Show the plot
