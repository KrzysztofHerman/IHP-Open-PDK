...
class gring(DloGen):
    ...
    def genLayout(self):
        ...
        actRect1 =  Rect(activlayer, Box(psdActiv, psdActiv, self.l - psdActiv, self.w - psdActiv))
        actRect2 =  Rect(activlayer, Box(minpSD - psdActiv , minpSD - psdActiv, self.l - minpSD + psdActiv, self.w - minpSD + psdActiv))

        lociRect1 =  Rect(locintlayer, Box(minpSD/2 - contbar_min_width/2 , minpSD/2 - contbar_min_width/2, self.l - minpSD/2 + contbar_min_width/2, self.w - minpSD/2 + contbar_min_width/2))
        lociRect2 =  Rect(locintlayer, Box(minpSD/2 + contbar_min_width/2, minpSD/2 + contbar_min_width/2, self.l - minpSD/2 - contbar_min_width/2, self.w - minpSD/2 - contbar_min_width/2))
        
        met1Rect1 =  Rect(met1layer, Box(minpSD/2 - contbar_min_width/2 - endcap, minpSD/2 - contbar_min_width/2 - endcap, self.l - minpSD/2 + contbar_min_width/2 + endcap, self.w - minpSD/2 + contbar_min_width/2 + endcap))
        met1Rect2 =  Rect(met1layer, Box(minpSD/2 + contbar_min_width/2 + endcap, minpSD/2 + contbar_min_width/2 + endcap, self.l - minpSD/2 - contbar_min_width/2 - endcap, self.w - minpSD/2 - contbar_min_width/2 - endcap))
